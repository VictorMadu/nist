...
// import { ControllerLoader, IAdapterT } from "../controller.loader";
...
//           expect(mockControllerAdapter).toHaveProperty("attach");
//         });
//         describe(`test for property 'attach'`, () => {
//           test(`should be defined`, () => {
//             expect(mockControllerAdapter.attach).toBeDefined();
//           });
//           test(`should be of type 'function'`, () => {
//             expect(typeof mockControllerAdapter.attach).toBe("function");
//           });
//         });
//       });
//     });
...
//             afterAll(() => {
//               mockControllerAdapter.attach.mockClear();
//             });
...
//           let mockAttachToRoute: jest.Mock<IAdapterT["attach"]>;
//           beforeAll(() => {
//             mockAttachToRoute = mockControllerAdapter.attach;
//           });

//           describe(`test for calls on 'ControllerAdapter''s 'attach'`, () => {
...
//             });
//           });
//           describe(`test for arguments passed to controllerAdapter's 'attach`, () => {
...
//                 arg1 = {
//                   base: {
//                     path: controller[METADATA_KEY].path,
//                   },
//                   method: {
//                     url: methodPath,
