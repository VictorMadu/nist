import { Inject, Injectable, IServiceDecoConstructor } from ".";
import * as inversify from "inversify";

jest.mock("inversify");

describe.skip(`test for Injectable`, () => {
  let DecoratedMClass: {
    new (...args: any[]): any;
    $KEY: symbol;
  };
...
// describe.skip(`test for Inject`, () => {
//   class MClass {}
//   let DecoratedMClass = Inject(MClass as any);
// });
